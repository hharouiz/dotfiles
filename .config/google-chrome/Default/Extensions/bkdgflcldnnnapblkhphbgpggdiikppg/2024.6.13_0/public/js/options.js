    ...
    "shared/js/ui/models/privacy-options.js"(exports2, module2) {
      ...
      PrivacyOptions.prototype = window.$.extend(
        ...
        Parent2.prototype,
        {
          ...
          async getState() {
            const [settings12, youtubeClickToLoadEnabled] = await Promise.all([
              this.sendMessage("getSetting", "all"),
              this.sendMessage("isClickToLoadYoutubeEnabled")
            ]);
            this.httpsEverywhereEnabled = settings12.httpsEverywhereEnabled;
            this.embeddedTweetsEnabled = settings12.embeddedTweetsEnabled;
            this.GPC = settings12.GPC;
            this.youtubeClickToLoadEnabled = youtubeClickToLoadEnabled;
            this.youtubePreviewsEnabled = settings12.youtubePreviewsEnabled;
            this.fireButtonEnabled = true;
            this.fireButtonClearHistoryEnabled = settings12.fireButtonClearHistoryEnabled;
            this.fireButtonTabClearEnabled = settings12.fireButtonTabClearEnabled;
          }
        }
      );
      module2.exports = PrivacyOptions;
        ...
        return function(strings) {
          ...
          for (var i = 0; i < strings.length; i++) {
            if (i < arglen - 1) {
              ...
              parts.push.apply(parts, parse3(strings[i]));
          }
          var tree = [null, {}, []];
          var stack = [[tree, -1]];
...
<li class="js-allowlist-list-item">
      ...
      Allowlist.prototype = window.$.extend(
        ...
        Parent2.prototype,
        {
          ...
          addDomain: function(url) {
            ...
            const parsedDomain = tldts2.parse(url);
  ...
  function mergeSavedSettings(settings12, results) {
    return Object.assign(settings12, results);
  }
  ...
  function getURL(pixelName) {
    if (!pixelName)
      throw new Error("pixelName is required");
  ...
  function getUserLocale() {
    if (!import_webextension_polyfill2.default?.i18n) {
      return "en";
    }
    const lang = import_webextension_polyfill2.default.i18n.getUILanguage().slice(0, 2);
    ...
    "shared/js/background/settings.js"(exports2, module2) {
      ...
      function checkForLegacyKeys() {
        ...
        for (const legacyKey in legacyKeys) {
          ...
          if (!(legacyKey in settings12)) {
            continue;
          }
          syncNeeded = true;
          const legacyValue = settings12[legacyKey];
          if (key && legacyValue) {
            settings12[key] = legacyValue;
          }
          delete settings12[legacyKey];
        }
        if (syncNeeded) {
      ...
      async function buildSettingsFromLocalStorage() {
        ...
        if (!results)
          return;
        settings12 = browserWrapper5.mergeSavedSettings(settings12, results);
        checkForLegacyKeys();
      }
      ...
      function buildSettingsFromDefaults() {
        settings12 = Object.assign({}, defaultSettings);
      }
      function syncSettingTolocalStorage() {
        return browserWrapper5.syncToStorage({ settings: settings12 });
      }
    ...
    "shared/js/shared-utils/parse-user-agent-string.js"(exports2, module2) {
      ...
      module2.exports = (uaString) => {
        if (!globalThis.navigator)
          return {};
        if (!uaString)
          uaString = globalThis.navigator.userAgent;
        let browser9;
        let version;
        try {
        ...
        let os = "o";
        if (globalThis.navigator.userAgent.indexOf("Windows") !== -1)
          os = "w";
        if (globalThis.navigator.userAgent.indexOf("Mac") !== -1)
          os = "m";
        if (globalThis.navigator.userAgent.indexOf("Linux") !== -1)
          os = "l";
        return {
          os,
          browser: browser9,
  ...
  function isBroken(url) {
    if (!tds_default?.config.unprotectedTemporary)
      return;
  ...
  function getEnabledFeaturesAboutBlank(url) {
    if (!tds_default.config.features)
      return [];
  ...
  function constructUrl(querystring, truncate) {
    ...
    const browser9 = browserInfo2?.browser;
    ...
    if (browser9) {
      url += `_${browser9.toLowerCase()}`;
    }
    url += `?${randomNum}&`;
    let extraParams = "";
    [...Object.values(requestCategoryMapping)].forEach((key) => {
      if (truncate && truncatableFields.includes(key))
        return;
  ...
  async function breakageReportForTab({
    ...
    if (lastSentDay)
      brokenSiteParams.set("lastSentDay", lastSentDay);
    if (ampUrl)
      brokenSiteParams.set("ampUrl", ampUrl);
    if (category)
      brokenSiteParams.set("category", category);
    if (debugFlags)
      brokenSiteParams.set("debugFlags", debugFlags);
    if (description)
      brokenSiteParams.set("description", description);
    if (errorDescriptions)
      brokenSiteParams.set("errorDescriptions", errorDescriptions);
    if (httpErrorCodes)
      brokenSiteParams.set("httpErrorCodes", httpErrorCodes);
      ...
      var Companies3 = (() => {
        ...
        return {
          ...
          countCompanyOnPage: (c) => {
            ...
            if (c.name !== "unknown")
              companyContainer[c.name].incrementPagesSeenOn();
          },
          all: () => {
  ...
  var import_rulePriorities, import_utils2, getFeatureSettings2, getBaseDomain2, browserWrapper2, getNextSessionRuleId2, manifestVersion, AdClickAttributionPolicy, AdClick;
  var init_ad_click_attribution_policy = __esm({
    "shared/js/background/classes/ad-click-attribution-policy.js"() {
      ...
      AdClick = class _AdClick {
        ...
        getAdClickDNR(tabId) {
          const adClickDNR = {
            rule: (0, import_utils2.generateDNRRule)({
              id: null,
          ...
          for (const [key, value] of Object.entries(parsedData)) {
            if (key === "trackers") {
              ...
              for (const trackerKey of Object.keys(value)) {
                ...
                trackers4[trackerKey] = Tracker.restore(tracker);
              }
              state[key] = trackers4;
  ...
  var import_tldts2, settings5, utils, tdsStorage, privacyPractices, Grade, browserWrapper3, TabState2, Site;
  var init_site = __esm({
    "shared/js/background/classes/site.js"() {
      "use strict";
  ...
  var import_settings3, USER_ALLOWLIST_RULE_ID, SERVICE_WORKER_INITIATED_ALLOWING_RULE_ID, HTTPS_SESSION_ALLOWLIST_RULE_ID, HTTPS_SESSION_UPGRADE_RULE_ID, GPC_HEADER_RULE_ID, SETTING_PREFIX, ruleIdRangeByConfigName, findExistingDynamicRule, findExistingSessionRule;
    ...
    "shared/js/background/classes/tab.js"(exports2, module2) {
      ...
      var Tab = class _Tab {
        ...
        allowAdAttribution(resourcePath) {
          if (!this.site.isFeatureEnabled("adClickAttribution") || !this.adClick || !this.adClick.allowAdAttribution(this))
            return false;
          const policy = this.getAdClickAttributionPolicy();
          return policy.resourcePermitted(resourcePath);
        }
        updateSite(url) {
          if (this.site.url === url)
            return;
          this.url = url;
        ...
        addToTrackers(t2, baseDomain, url) {
          ...
          if (tracker) {
            ...
            if (t2.tracker.owner.name !== "unknown")
              Companies3.countCompanyOnPage(t2.tracker.owner);
          }
          this.trackers = trackers4;
         ...
         */
        postDevtoolsMessage(devtools2, action, message) {
          devtools2.postMessage(this.id, action, message);
        }
      };
      module2.exports = Tab;
    }
  ...
  var require_sw_tab = __commonJS({
    "shared/js/background/classes/sw-tab.js"(exports2, module2) {
      ...
      var ServiceWorkerTab = class extends Tab {
         ...
         */
        postDevtoolsMessage(devtools2, action, message) {
          this._findMatchingTabs().forEach((tab) => tab.postDevtoolsMessage(devtools2, action, message));
        }
      };
  ...
  var require_trackers2 = __commonJS({
    "shared/js/background/trackers.js"(exports2, module2) {
      ...
      var TrackersInstance = new Trackers({ tldjs: tldts2, utils: utils4 });
  ...
  async function ensureGPCHeaderRule(config = null) {
    ...
    const gpcEnabled = import_settings4.default.getSetting("GPC") && config?.features?.gpc?.state === "enabled";
    if (gpcEnabled) {
      addRules.push(
  ...
  var import_settings4, import_gpc;
  var init_dnr_gpc = __esm({
    "shared/js/background/dnr-gpc.js"() {
      ...
      import_settings4.default.onSettingUpdate.addEventListener(
        "GPC",
        () => {
          ensureGPCHeaderRule();
        }
  ...
  async function ensureServiceWorkerInitiatedRequestExceptions(config) {
    ...
    if (config.features.serviceworkerInitiatedRequests?.state !== "enabled") {
      addRules.push((0, import_utils3.generateDNRRule)({
  ...
  var import_rulePriorities2, import_utils3;
  ...
  function generateEtagRule(id, etag) {
    return (0, import_utils5.generateDNRRule)({
      id,
      priority: 1,
      actionType: "allow",
      urlFilter: etag,
  ...
  async function configRulesNeedUpdate(configName, expectedState) {
    ...
    const settingValue = import_settings5.default.getSetting(settingName);
    if (!settingValue) {
      return true;
    }
  ...
  async function updateConfigRules(configName, latestState, rules, matchDetailsByRuleId, allowingRulesByClickToLoadAction = {}) {
    ...
    if (Object.keys(allowingRulesByClickToLoadAction).length) {
      import_settings5.default.updateSetting("allowingDnrRulesByClickToLoadRuleAction", allowingRulesByClickToLoadAction);
    }
    import_settings5.default.updateSetting(settingName, settingValue);
  }
  ...
  async function updateCombinedConfigBlocklistRules() {
    const extensionVersion = getExtensionVersion();
    const denylistedDomains = await getDenylistedDomains();
    const tdsEtag = import_settings5.default.getSetting("tds-etag");
    const combinedState = {
      etag: `${import_settings5.default.getSetting("config-etag")}-${tdsEtag}`,
      denylistedDomains: denylistedDomains.join(),
      extensionVersion
    };
  ...
  var import_settings5, import_trackers, import_extensionConfiguration, import_tds7, import_utils5, import_combined, ruleUpdateLock;
  ...
  async function updateUserAllowlistRule(allowlistedDomains) {
    ...
    if (allowlistedDomains.length > 0) {
      addRules.push((0, import_utils6.generateDNRRule)({
  ...
  async function getDenylistedDomains() {
    ...
    const denylist = import_settings6.default.getSetting("denylisted") || {};
  ...
  var import_settings6, import_rulePriorities3, import_utils6;
  ...
  var require_tab_manager = __commonJS({
    "shared/js/background/tab-manager.js"(exports2, module2) {
      "use strict";
      var Companies3 = require_companies();
      var settings12 = require_settings();
      var Tab = require_tab();
      ...
      var TabManager = class {
        ...
        setGlobalAllowlist(list, domain, value) {
          const globalallowlist = settings12.getSetting(list) || {};
          if (value) {
            globalallowlist[domain] = true;
          } else {
            delete globalallowlist[domain];
          }
          settings12.updateSetting(list, globalallowlist);
        }
  ...
  __export(devtools_exports, {
    ...
    registerDebugHandler: () => registerDebugHandler,
    serializeTab: () => serializeTab
  });
  function init() {
    import_webextension_polyfill4.default.runtime.onConnect.addListener(connected);
  }
  function registerDebugHandler(tabId, fn) {
  ...
  function connected(port) {
    ...
    port.onMessage.addListener((m) => {
      if (m.action === "setTab") {
        ...
        const matchedTracker = trackers3.getTrackerData(requestData.url, siteUrl, requestData);
  ...
  var import_webextension_polyfill4, tldts, tabManager, trackers3, removeBroken2, ports, debugHandlers;
  var init_devtools = __esm({
    "shared/js/background/devtools.js"() {
      ...
      debugHandlers = /* @__PURE__ */ new Map();
    }
  });
  ...
  function getArgumentsObject(tabId, sender, documentUrl, sessionKey) {
    ...
    site.enabledFeatures = site.enabledFeatures.filter((feature) => {
      if (feature === "trackerAllowlist")
        return false;
      if (feature === "referrer" && !tab.referrer?.referrer)
        return false;
      return true;
    });
  ...
  var utils2, tabManager2, trackerutils, settings10, isActive2, constants2, LegacyTabTransfer2;
  ...
  var import_webextension_polyfill5, import_tldts4, isFireButtonEnabled;
  ...
  function openOptions() {
    if (browserName === "moz") {
      import_webextension_polyfill6.default.tabs.create({ url: getExtensionURL("/html/options.html") });
    } else {
      import_webextension_polyfill6.default.runtime.openOptionsPage();
    }
  }
  async function submitBrokenSiteReport(breakageReport) {
    ...
    const tds = settings11.getSetting("tds-etag");
    const remoteConfigEtag = settings11.getSetting("config-etag");
  ...
  async function getTab(tabId) {
    await settings11.ready();
    await tds_default.ready("config");
    return tabManager3.getOrRestoreTab(tabId);
  }
  async function getPrivacyDashboardData(options) {
    ...
    if (!tab)
      throw new Error("unreachable - cannot access current tab with ID " + tabId);
    const userData = settings11.getSetting("userData");
  ...
  async function getClickToLoadState() {
    ...
    await settings11.ready();
    const youtubePreviewsEnabled = await settings11.getSetting("youtubePreviewsEnabled") || false;
  ...
  function search({ term }) {
    ...
    if (browserInfo2?.os) {
      ...
      import_webextension_polyfill6.default.tabs.create({ url: url.toString() });
    }
  }
  ...
  var import_webextension_polyfill6, import_parse_user_agent_string2, utils3, settings11, tabManager3, Companies2, browserName, devtools, browserWrapper4, messageHandlers;
  ...
  var import_webextension_polyfill7, import_tldts5, MENU_ITEM_ID, REFETCH_ALIAS_ALARM, REFETCH_ALIAS_ATTEMPT, pixelsEnabled, EmailAutofill, getFullPixelName, fireIncontextSignupPixel, formatAddress, isValidUsername, isValidToken;
  var init_email_autofill = __esm({
    "shared/js/background/components/email-autofill.js"() {
      ...
      EmailAutofill = class {
         ...
         * }} options
         */
        constructor({ settings: settings12 }) {
          this.settings = settings12;
          this.contextMenuAvailable = !!import_webextension_polyfill7.default.contextMenus;
          if (this.contextMenuAvailable) {
            import_webextension_polyfill7.default.contextMenus.create({
              id: MENU_ITEM_ID,
              ...
              const { lastError } = import_webextension_polyfill7.default.runtime;
              if (lastError && lastError.message && !lastError.message.startsWith("Cannot create item with duplicate id")) {
                throw lastError;
              }
            });
            import_webextension_polyfill7.default.contextMenus.onClicked.addListener((info, tab) => {
              const userData = this.settings.getSetting("userData");
              if (tab?.id && userData.nextAlias) {
                import_webextension_polyfill7.default.tabs.sendMessage(tab.id, {
          ...
          import_webextension_polyfill7.default.alarms.onAlarm.addListener((alarmEvent) => {
        ...
        async fetchAlias() {
          await this.settings.ready();
          import_webextension_polyfill7.default.alarms.clear(REFETCH_ALIAS_ALARM);
          const userData = this.settings.getSetting("userData");
          if (!userData?.token)
            return;
        ...
        showContextMenuAction() {
          if (this.contextMenuAvailable) {
            import_webextension_polyfill7.default.contextMenus.update(MENU_ITEM_ID, { visible: true });
          }
        }
        hideContextMenuAction() {
          if (this.contextMenuAvailable) {
            import_webextension_polyfill7.default.contextMenus.update(MENU_ITEM_ID, { visible: false });
          }
        }
        /**
         *
        ...
        fireAutofillPixel(pixel, shouldUpdateLastUsed = false) {
          ...
          sendPixelRequest(getFullPixelName(pixel, browserName2), { duck_address_last_used: lastAddressUsedAt, cohort: userData.cohort });
      ...
      getFullPixelName = (name, browserName2) => {
        return `${name}_${browserName2.toLowerCase()}`;
      };
      fireIncontextSignupPixel = (pixel, params) => {
        const browserName2 = getBrowserName() ?? "unknown";
        if (!pixelsEnabled)
          return;
        sendPixelRequest(getFullPixelName(pixel, browserName2), params);
      };
  ...
  var import_webextension_polyfill8, sendMessage, backgroundMessage, getExtensionURL2, openExtensionPage2;
  var init_ui_wrapper = __esm({
    "shared/js/ui/base/ui-wrapper.js"() {
      ...
      sendMessage = async (messageType, options) => {
        return await import_webextension_polyfill8.default.runtime.sendMessage({ messageType, options });
      };
      backgroundMessage = (thisModel) => {
        import_webextension_polyfill8.default.runtime.onMessage.addListener((req, sender) => {
          if (sender.id !== import_webextension_polyfill8.default.runtime.id)
            return;
          if (req.updateTabData)
            thisModel.send("updateTabData");
          if (req.didResetTrackersData)
            thisModel.send("didResetTrackersData", req.didResetTrackersData);
          if (req.closePopup)
            window.close();
        });
      };
      getExtensionURL2 = (path) => {
        return import_webextension_polyfill8.default.runtime.getURL(path);
      };
      openExtensionPage2 = (path) => {
        import_webextension_polyfill8.default.tabs.create({ url: getExtensionURL2(path) });
      };
    }
  });
